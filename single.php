...
if (isset($_POST['post_comment'])) {
  if (trim($_POST['name']) != "" || trim($_POST['comment']) != "") {
    ...
    // $comment_insert = $comment_insert->fetch();
             ...
             <div class="row">
               ...
               <div class="p-3">
                 <div class="d-flex align-items-center">
                   ...
                   <div class="mr-2">
                     <span class="badge badge-secondary"><?php echo $post_category['id'] ?></span>
                 ...
                 foreach ($comments as $comment) {
                   ...
                   <div class="col-12 mb-3">
                     <div class="card bg-light">
                       <div class="card-body">
                         <div class="d-flex align-items-center">
                           <img src="./img/boy.svg" width="70" height="70" class="rounded-circle" alt="Cinque Terry">
                           <div class="mr-3">
