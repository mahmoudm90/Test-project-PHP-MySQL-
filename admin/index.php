              ...
              foreach ($posts as $post) {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="index.php?entity=post&action=delete&id=<?php echo $post['id'] ?>" class="btn btn-outline-info">حذف</a>
                  </td>
                </tr>
                <?php
              }
            ...
            if ($comments->rowcount()>0) {
              foreach ($comments as $comment) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?entity=comment&action=approve&id=<?php echo $comment['id'] ?>" class="btn btn-outline-info">تایید</a>
                    <a href="index.php?entity=post&action=delete&id=<?php echo $comment['id'] ?>" class="btn btn-outline-info">حذف</a>
                  </td>
                </tr>
                <?php
              ...
              foreach ($categories as $category) {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="index.php?entity=category&action=delete&id=<?php echo $category['id'] ?>" class="btn btn-outline-info">حذف</a>
                  </td>
                </tr>
                <?php
